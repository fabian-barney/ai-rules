...
- Specialized docs (for example typed-JavaScript and framework docs) may
...
## Override Notes
- Typed-JavaScript specializations may narrow typing discipline and compile-time
  safety rules for TypeScript-like codebases.
